const presidents = [
    ...
    function myArray() {
        ...
        for(let i = 0; i < presidents.length; i++){
            //console.log[i].year; //this populates the presidents array itself
            let obj = {
                last: presidents[i].last, //catches last name
                year: presidents[i].year, //catches year
            };
            newArray.push(obj); //.push adds it to the end
        }
